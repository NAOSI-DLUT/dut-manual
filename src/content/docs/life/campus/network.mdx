...
宿舍内每人有一个有线网口，校内各楼宇也有几乎全覆盖的 WiFi。价格方面，每月 20 元 150GB 流量，通过大工学生系统 SSO 登陆使用。网速方面，IPv4 限速 100 兆，IPv6 有线连接下理论速度最高为千兆，实际上由于信号衰减等最高大概在三百到六百兆左右 。另外实验室、创中的 WiFi 不限量。或者去机房也能蹭免费网络。
...
2. 上文提到的校园网自助服务系统与开发区校区无关，是主校区的校园网自助服务系统
3. 上文提到的校园网自助服务系统仅能在校园网环境下访问
</Aside>

## “校园”卡

校园卡是各大运营商提供的一种带学生优惠套餐的 SIM 卡，和大连理工大学**没有任何关系**，无法直接使用大连理工大学校内网络资源且不受校园网管控。说白了就是流量卡（甚至还不如流量卡，因为有仅限校园基站的流量的限制）。

<Aside>
  不推荐购买！！！易受信号屏蔽影响且流量套餐不划算（全国通用流量仅有45G），推荐使用校园网或运营商的大流量套餐。大流量套餐自行在 bilibili 搜索即可。
</Aside>
